...
class TestIndexDocument:
    def _run(
        ...
        bm25_in = list(existing_bm25) if existing_bm25 is not None else []
        with patch("ingestion.indexer._embed_model", mock_model):
        ...
        return result, mock_qdrant, mock_model
    ...
    def test_only_children_are_embedded(self):
        ...
        _, _, mock_model = self._run([parent, child, table])
