...
class QueryRouterConfig:
    ...
    model: str = field(default_factory=lambda: _env_str("RAG_QUERY_ROUTER_MODEL", "gpt-4o-mini"))
...
class QueryTransformConfig:
    ...
    model: str = field(default_factory=lambda: _env_str("RAG_QUERY_TRANSFORM_MODEL", "gpt-4o-mini"))
...
class GenerationConfig:
    ...
    model: str = field(default_factory=lambda: _env_str("RAG_GENERATION_MODEL", "gpt-4o-mini"))
...
class CRAGConfig:
    ...
    grader_model: str = field(
        default_factory=lambda: _env_str("RAG_CRAG_GRADER_MODEL", "gpt-4o-mini")
    )
...
class EvaluationConfig:
    ...
    model: str = field(default_factory=lambda: _env_str("RAG_EVAL_MODEL", "gpt-4o-mini"))
...
class KnowledgeGraphConfig:
    ...
    extraction_model: str = field(
        default_factory=lambda: _env_str("RAG_KG_EXTRACTION_MODEL", "gpt-4o-mini")
    )
